...
describe('profileListModel', () => {
    ...
    it('builds backend subtitle for enabled compatible agents', () => {
        const profile = { isBuiltIn: false, compatibility: { claude: true, codex: true, opencode: true, gemini: true, auggie: true, qwen: false, kimi: false } } as Pick<AIBackendProfile, 'compatibility' | 'isBuiltIn'>;
    ...
    it('builds built-in subtitle with backend', () => {
        const profile = { isBuiltIn: true, compatibility: { claude: true, codex: false, opencode: false, gemini: false, auggie: false, qwen: false, kimi: false } } as Pick<AIBackendProfile, 'compatibility' | 'isBuiltIn'>;
    ...
    it('builds custom subtitle without backend', () => {
        const profile = { isBuiltIn: false, compatibility: { claude: false, codex: false, opencode: false, gemini: false, auggie: false, qwen: false, kimi: false } } as Pick<AIBackendProfile, 'compatibility' | 'isBuiltIn'>;
